...
public class MathLibrary implements Reporter {
	public enum MathCommand { ABS, ACOS, ADD_EXACT, ASIN, ATAN, ATAN2, CBRT, CEIL, COPY_SIGN, COS, COSH, DECREMENT_EXACT, E,
		EXP, EXPM1, FLOOR, FLOOR_DIV, FLOOR_MOD, GET_EXPONENT, HYPOT, IEEE_REMAINDER, INCREMENT_EXACT, LOG, LOG10, LOG1P,
		MAX, MIN, MULTIPLY_EXACT, NEGATE_EXACT, NEXT_AFTER, NEXT_DOWN, NEXT_UP, PI, POW, RANDOM, RINT, ROUND, SCALB, SIGNUM,
		SIN, SINH, SQRT, SUBTRACT_EXACT, TAN, TANH, TO_DEGREES, TO_INT_EXACT, TO_RADIANS, ULP};
